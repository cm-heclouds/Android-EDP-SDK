            ...
            for (EdpMsg msg : msgList) {
                ...
                switch (msg.getMsgType()) {
                    ...
                    case Common.MsgType.CONNRESP:
                        ...
                        Log.i(App.LOG_TAG, "连接响应码: " + connectRespMsg.getResCode());
                    ...
                    case Common.MsgType.SAVERESP:
                        ...
                        Log.i(App.LOG_TAG, "存储确认: " + new String(saveRespMsg.getData()));
                    ...
                    case Common.MsgType.PUSHDATA:
                        ...
                        Log.i(App.LOG_TAG, "透传数据: " + new String(pushDataMsg.getData()));
                    ...
                    case Common.MsgType.CMDREQ:
                        ...
                        Log.i(App.LOG_TAG, "cmdid: " + cmdMsg.getCmdId() + "\n命令请求内容: " + new String(cmdMsg.getData()));
